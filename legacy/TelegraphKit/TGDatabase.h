...
- (void)storeConversationState:(int64_t)conversationId state:(NSString *)state replyMessageId:(int32_t)replyMessageId forwardMessageDescs:(NSArray *)forwardMessageDescs;
