...
static UIImage *TGMediaPickerGalleryCheckButtonImageNormal()
{
...
static UIImage *TGMediaPickerGalleryCheckButtonImageChecked()
{
    static UIImage *image = nil;
    if (image == nil)
...
@implementation TGMediaPickerGalleryCheckButton
...
{
    _checkView.image = checked ? TGMediaPickerGalleryCheckButtonImageChecked() : TGMediaPickerGalleryCheckButtonImageNormal();
