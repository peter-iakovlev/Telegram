...
- (void)execute:(NSDictionary *)options
{
    ...
    NSString *url = [[NSString alloc] initWithFormat:@"http://api.giphy.com/v1/gifs/search?q=%@&offset=%d&limit=60&api_key=141Wa2KDAfNfxu", [TGStringUtils stringByEscapingForURL:options[@"query"]], (int)_currentItems.count];
