...
- (void)loadView
{
    ...
    if (TGLocationPickerPlacesProvider == TGLocationPlacesServiceFoursquare)
    {
        ...
        _attributionView.image = [UIImage imageNamed:@"FoursquareAttribution.png"];
    ...
    [_userLocationButton setImage:[UIImage imageNamed:@"TrackingLocation.png"] forState:UIControlStateNormal];
    ...
    [_mapModeButton setImage:[UIImage imageNamed:@"LocationInfo.png"] forState:UIControlStateNormal];
    [_mapModeButton setImage:[UIImage imageNamed:@"LocationInfo_Active.png"] forState:UIControlStateSelected];
    [_mapModeButton setImage:[UIImage imageNamed:@"LocationInfo_Active.png"] forState:UIControlStateSelected | UIControlStateHighlighted];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (_intent != TGLocationPickerControllerCustomLocationIntent)
    {
        [TGAccessChecker checkLocationAuthorizationStatusForIntent:TGLocationAccessIntentSend alertDismissComlpetion:^
        {
...
- (void)_setMapCenterCoordinate:(CLLocationCoordinate2D)coordinate span:(MKCoordinateSpan)span offset:(CGPoint)offset animated:(bool)animated
{
    ...
    {
        TGLog(@"ERROR: failed to set location picker map region with exception: %@", exception);
    }
}
