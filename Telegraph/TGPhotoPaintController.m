...
- (void)loadView
{
    ...
    _portraitSettingsView = [[TGPhotoPaintSettingsView alloc] init];
    ...
    _landscapeSettingsView = [[TGPhotoPaintSettingsView alloc] init];
...
- (void)presentStickersView
{
    ...
    {
        TGPhotoStickersView *view = [[TGPhotoStickersView alloc] initWithFrame:self.view.bounds];
