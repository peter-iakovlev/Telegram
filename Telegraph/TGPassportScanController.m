...
- (void)loadView
{
    ...
    _titleLabel.textColor = _presentation.pallete.textColor;
    ...
    _descriptionLabel.textColor = _presentation.pallete.textColor;
...
- (void)setPresentation:(TGPresentation *)presentation
{
    ...
    _descriptionLabel.textColor = presentation.pallete.textColor;
}
