...
- (SSignal *)pooledConnectionContextForDatacenter:(NSInteger)datacenterId
{
    ...
    return [[SSignal alloc] initWithGenerator:^id<SDisposable>(SSubscriber *subscriber)
    {
        ...
        if (strongSelf != nil)
        {
            ...
            {
                MTProto *mtProto = [[MTProto alloc] initWithContext:strongSelf->_mtContext datacenterId:datacenterId];
                ...
                datacenterConnectionContext = [[TGDatacenterConnectionContext alloc] initWithMtContext:strongSelf->_mtContext mtProto:mtProto mtRequestService:mtRequestService];
            }
